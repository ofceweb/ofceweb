...
1. Initialise la branche orpheline `gh-pages` (pré-publication GitHub Pages)
2. Copie les gabarits (`_quarto.yml`, `index.qmd`, `annexes.qmd`, `news.qmd`)
3. Copie les assets OFCE (`www/`) et l'extension Quarto (`_extensions/wp/`)
4. Copie les workflows GitHub Actions (`.github/workflows/`)
5. Adapte `_quarto.yml` avec le titre, l'URL, le numéro WP, l'année, la langue
