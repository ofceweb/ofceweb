...
jamais supprimées automatiquement. Juste avant cet appel,
\`setup_prev()\` vérifie aussi (via \`check_ofce_version()\`) que le
package \*\*ofce\*\* installé est en version \`\>= 1.3.39\` — sinon la
