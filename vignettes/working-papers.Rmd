...
|             |               | Pages ou    |                                         |
|             |               |             | `www.ofce.fr/staging/{repo}/{version}`  |
|             |               | OFCE        |                                         |
|             |               | staging     |                                         |
+-------------+---------------+-------------+-----------------------------------------+
...
Lorsque le docuement de travail est *stagé* sur le site ofce.fr, il est possible de versionner. Le versionnage est impossible sur github gh-pages.
...
- **Brouillon** (`wp: null`) → `quarto publish gh-pages` (publie sur
  `ofce.github.io/{repo}/`) ou pousse en staging sur le site de l'ofce à l'adresse `www.ofce.fr/stage/{repo}/{version}/`.
